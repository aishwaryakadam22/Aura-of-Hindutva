...
if (isset($_POST['add_product'])) {
   ...
   $category = $_POST['name'];       // extra added line
   $price = $_POST['price'];
   ...
   if (isset($_POST['add_product'])) {
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO products (name, price, image, audiobook, ebook, category) VALUES ('$name', '$price', '$image', '$audiobook', '$ebook', '$category')") or die('query failed');

      // Existing code...
   } else {
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, audiobook, ebook ) VALUES('$name', '$price', '$image', '$audiobook', '$ebook')") or die('query failed');
...
<body>
   ...
   <section class="add-products">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <input type="file" name="audiobook" accept="audio/mp3, audio/mpeg" class="box">
         <input type="file" name="ebook" accept="application/pdf" class="box">
   ...
   <section class="edit-product-form">
      ...
      ?>
               <form action="" method="post" enctype="multipart/form-data">
                  ...
                  <input type="file" name="update_audiobook" accept="audio/mp3, audio/mpeg" class="box">
                  <input type="file" name="update_ebook" accept="application/pdf" class="box">
